              ...
              {subscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
                  ...
                  <input
                    ...
                    required
                    className="flex-1 min-w-0 h-10 px-3 text-sm bg-surface border border-border rounded-lg text-primary placeholder-[#9CA3AF] focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                  />
                  <button
                    type="submit"
                    className="h-10 px-4 bg-primary text-white text-[13px] font-semibold rounded-lg hover:bg-primary-hover transition-colors whitespace-nowrap flex items-center justify-center shrink-0"
                  >
                    Subscribe
                  </button>
                </form>
