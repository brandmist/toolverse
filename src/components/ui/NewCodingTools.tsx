    ...
    <div className="flex flex-col gap-4 h-full bg-white border border-[#E5E7EB] rounded-2xl p-6  shadow-lg shadow-sm">
      <div className="flex gap-2 items-center">
        <div className="flex gap-2">
          <button onClick={() => setMode('minify')} className={`px-4 py-2 rounded-lg text-sm font-medium border transition-colors ${mode === 'minify' ? 'bg-white border border-[#E5E7EB] border-[#E5E7EB] text-[#111827]' : 'bg-white border border-[#E5E7EB] border-[#E5E7EB] text-[#6B7280] hover:text-[#111827]'}`}>Minify</button>
          <button onClick={() => setMode('prettify')} className={`px-4 py-2 rounded-lg text-sm font-medium border transition-colors ${mode === 'prettify' ? 'bg-white border border-[#E5E7EB] border-[#E5E7EB] text-[#111827]' : 'bg-white border border-[#E5E7EB] border-[#E5E7EB] text-[#6B7280] hover:text-[#111827]'}`}>Prettify</button>
        </div>
    ...
    <div className="flex flex-col gap-4 h-full bg-white border border-[#E5E7EB] rounded-2xl p-6  shadow-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <textarea className="w-full h-52 p-4 bg-white border border-[#E5E7EB] border-[#E5E7EB] rounded-xl resize-none text-[#111827] font-mono text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50" value={left} onChange={e => setLeft(e.target.value)} />
        </div>
        <div>
          <label className="text-sm text-[#111827] mb-2 block">Modified Code</label>
          <textarea className="w-full h-52 p-4 bg-white border border-[#E5E7EB] border-[#E5E7EB] rounded-xl resize-none text-[#111827] font-mono text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50" value={right} onChange={e => setRight(e.target.value)} />
        </div>
      </div>
