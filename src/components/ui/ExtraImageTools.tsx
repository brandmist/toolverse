    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload photo for Profile Picture</p>
          <p className="text-muted text-xs">Crops to circle, applies gorgeous borders and drop-shadows instantly</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Profile Customizer</h4>
              <div>
                <label className="text-xs text-muted block mb-1">Zoom Scale</label>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Border Width: {borderWidth}px</label>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Border Color</label>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Shadow Blur: {shadowBlur}px</label>
            ...
            <div className="space-y-2 pt-4">
              <Button onClick={handleDownload} className="w-full bg-white border border-border hover:bg-white-hover text-primary text-sm">
                Download Rounded Image
              </Button>
              <Button variant="outline" className="w-full border-border text-primary text-sm" onClick={() => { setFile(null); setPreviewUrl(null) }}>
                Clear
              </Button>
            </div>
          </div>
          <div className="flex-[2] flex items-center justify-center p-4 bg-white border border-border rounded-2xl border border-border min-h-[350px]">
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          <ImageIcon className="w-12 h-12 text-primary mb-4" />
          <p className="text-primary font-medium mb-1">Click to upload photo to Blur Background</p>
          <p className="text-muted text-xs">Uses AI client-side WASM to isolate foreground and apply smooth lens blur background</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              {!removedBgUrl ? (
                <div className="space-y-2">
                  <p className="text-xs text-muted">Step 1: Isolate subject using AI models</p>
                  <Button onClick={removeBackground} className="w-full bg-white border border-border hover:bg-white-hover text-primary font-semibold text-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-xs text-muted block mb-1">Blur Intensity: {blurAmount}px</label>
            ...
            <div className="pt-4 space-y-2">
              {removedBgUrl && (
                <Button onClick={download} className="w-full bg-white border border-border hover:bg-white-hover text-primary font-semibold text-sm">
                  <Download className="w-4 h-4 mr-2" /> Download Photo
                </Button>
              )}
              <Button variant="outline" className="w-full border-border text-primary text-sm" onClick={() => { setFile(null); setPreviewUrl(null); setRemovedBgUrl(null) }}>
                Reset
              </Button>
            </div>
          </div>
          
          <div className="flex-[2] flex items-center justify-center p-4 bg-white border border-border rounded-2xl border border-border min-h-[350px] relative">
            {removedBgUrl ? (
            ...
            {processing && (
              <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-sm rounded-xl flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-primary font-medium text-sm">{statusText}</p>
              </div>
            )}
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          <ImageIcon className="w-12 h-12 text-primary mb-4" />
          <p className="text-primary font-medium mb-1">Click to upload photo to Remove Watermark/Person</p>
          <p className="text-muted text-xs">Draw/brush over text logo watermarks or people to smudge-erase them locally</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Object/Watermark Eraser</h4>
              <p className="text-xs text-muted">Click and drag paint over any text watermark or person coordinates in the photo right preview pane.</p>
              <div>
                <label className="text-xs text-muted block mb-1">Brush Size: {brushSize}px</label>
            ...
            <div className="pt-4 space-y-2">
              <Button onClick={handleDownload} className="w-full bg-white border border-border hover:bg-white-hover text-primary font-semibold text-sm">
          ...
          <div className="flex-[2] flex justify-center bg-white border border-border rounded-2xl border border-border overflow-hidden relative">
            <canvas 
              ref={canvasRef} 
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {images.length === 0 ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload multiple photos to merge/combine</p>
          <p className="text-muted text-xs">Stitches images side-by-side or stacked vertically</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-muted uppercase">Merged Images</span>
                <button onClick={() => { const i = document.createElement('input'); i.type = 'file'; i.multiple = true; i.accept = 'image/*'; i.onchange = handleUpload as any; i.click() }} className="text-xs text-primary hover:text-primary">+ Add More</button>
              </div>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Stitching Direction</label>
                <div className="grid grid-cols-2 gap-2">
                  <button onClick={() => setDirection('horizontal')} className={`py-1.5 rounded text-xs font-bold ${direction === 'horizontal' ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>Horizontal</button>
                  <button onClick={() => setDirection('vertical')} className={`py-1.5 rounded text-xs font-bold ${direction === 'vertical' ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>Vertical</button>
                </div>
              </div>

              <div>
                <label className="text-xs text-muted block mb-1">Gap spacing: {gap}px</label>
                <input type="range" min="0" max="100" value={gap} onChange={e => setGap(parseInt(e.target.value))} className="w-full accent-indigo-500" />
              </div>

              <div>
                <label className="text-xs text-muted block mb-1">Backdrop Fill Color</label>
            ...
            <div className="pt-4 space-y-2">
              ...
              <Button variant="outline" className="w-full border-border text-primary text-sm" onClick={() => setImages([])}>
                Clear
              </Button>
            </div>
          </div>
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload photo to remove specific background colors</p>
          <p className="text-muted text-xs">Click on any background pixel in the preview pane to transparency key it out</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Color Key Transparency</h4>
              <p className="text-xs text-muted">Adjust the color matching tolerance slider below, then click any background color on the preview pane image to erase it.</p>
              <div>
                <label className="text-xs text-muted block mb-1">Tolerance: {tolerance}</label>
          ...
          <div className="flex-[2] flex justify-center bg-white border border-border rounded-2xl border border-border overflow-hidden relative bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMUlEQVQ4T2NkYGAQYcAP3uCTZvQAw8gAAQMDwzyUog+S1AwybAAx6oZRMwyDQeQAAwMAXgEHB60tE7EAAAAASUVORK5CYII=')]">
            <canvas 
              ref={canvasRef} 
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload photo to add Text</p>
          <p className="text-muted text-xs">Easy text overlay with customizable color, size, and dragging coordinate parameters</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Text Parameters</h4>
              <div>
                <label className="text-xs text-muted block mb-1">String Text</label>
                <input type="text" value={text} onChange={e => setText(e.target.value)} className="w-full bg-white border border-border border-border rounded-xl px-3 py-1.5 text-primary font-mono text-xs" />
              </div>
              <div>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          <LayoutGrid className="w-12 h-12 text-primary mb-4" />
          <p className="text-primary font-medium mb-1">Click to upload photo to Split into Grid blocks</p>
          <p className="text-muted text-xs">Cuts image into rows and columns grid, packaging slices inside a ZIP</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Grid Matrix</h4>
              <div>
                <label className="text-xs text-muted block mb-1">Rows: {rows}</label>
                <input type="range" min="1" max="10" value={rows} onChange={e => setRows(parseInt(e.target.value))} className="w-full accent-indigo-500" />
              </div>
              <div>
                <label className="text-xs text-muted block mb-1">Columns: {cols}</label>
                <input type="range" min="1" max="10" value={cols} onChange={e => setCols(parseInt(e.target.value))} className="w-full accent-indigo-500" />
              </div>
            </div>
            
            <div className="pt-4 space-y-2">
              <Button onClick={handleSplit} className="w-full bg-white border border-border hover:bg-white-hover text-primary font-semibold text-sm" disabled={zipping}>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          <ImageIcon className="w-12 h-12 text-primary mb-4" />
          <p className="text-primary font-medium mb-1">Click to upload photo to Add Border</p>
          <p className="text-muted text-xs">Stamps colorful solid frame board borders around your picture dimensions</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Border Properties</h4>
              <div>
                <label className="text-xs text-muted block mb-1">Border Thickness: {borderWidth}px</label>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Frame Color</label>
                <input type="color" value={borderColor} onChange={e => setBorderColor(e.target.value)} className="w-full h-8 rounded cursor-pointer bg-transparent border-0" />
              </div>
            </div>
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload photo to Translate</p>
          <p className="text-muted text-xs">Performs OCR text isolation, translates text, and overlay stamps translation back onto coordinates</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Image Translator</h4>
              <div>
                <label className="text-xs text-muted block mb-1">Target Language</label>
                <select 
                  value={targetLang} 
                  onChange={e => setTargetLang(e.target.value)}
                  className="w-full bg-white border border-border border-border rounded-xl px-4 py-2 text-primary text-xs"
                >
                  {languages.map(l => (
            ...
            <div className="pt-4 space-y-2">
              <Button onClick={handleTranslate} className="w-full bg-white border border-border hover:bg-white-hover text-primary font-semibold text-sm" disabled={processing}>
                {processing ? 'Translating...' : 'Translate Image'}
              </Button>
              {file && (
                <Button onClick={handleDownload} variant="outline" className="w-full border-border text-primary text-sm">
                  Download Image
                </Button>
              )}
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload photo to Pixelate</p>
          <p className="text-muted text-xs">Converts photo to retro 8-bit grid pixelated layouts</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Pixelator settings</h4>
              <div>
                <label className="text-xs text-muted block mb-1">Pixel Box Size: {pixelSize}px</label>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {images.length === 0 ? (
        ...
        >
          <LayoutGrid className="w-12 h-12 text-primary mb-4" />
          <p className="text-primary font-medium mb-1">Click to upload up to 4 images to make Collage</p>
          <p className="text-muted text-xs">Packs layouts dynamically inside grid collage models</p>
        </div>
      ) : (
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-muted uppercase">Selected Images ({images.length}/4)</span>
                {images.length < 4 && (
                  <button onClick={() => { const i = document.createElement('input'); i.type = 'file'; i.multiple = true; i.accept = 'image/*'; i.onchange = handleUpload as any; i.click() }} className="text-xs text-primary hover:text-primary">+ Add</button>
                )}
              </div>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Grid Padding: {padding}px</label>
              ...
              <div>
                <label className="text-xs text-muted block mb-1">Spacing Color</label>
                <input type="color" value={bgColor} onChange={e => setBgColor(e.target.value)} className="w-full h-8 rounded cursor-pointer bg-transparent border-0" />
              </div>
            </div>
    ...
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      {!file ? (
        ...
        >
          ...
          <p className="text-primary font-medium mb-1">Click to upload animated GIF to convert to MP4</p>
          <p className="text-muted text-xs">Captures canvas frames and bundles them into playable video containers</p>
        </div>
      ) : (
        <div className="space-y-4 max-w-md mx-auto w-full text-center">
          <div className="bg-white border border-border border-border rounded-xl p-3 text-primary text-xs font-semibold">{file.name}</div>
          {recording && (
            <div className="flex justify-center items-center gap-3 text-primary py-4">
              <RefreshCw className="w-5 h-5 text-primary animate-spin" /> Recording frames locally...
            </div>
          )}
          {videoUrl && (
            <div className="space-y-4">
              <video src={videoUrl} controls loop autoPlay className="w-full max-h-60 rounded-xl border border-border" />
              <a href={videoUrl} download={`${file.name.replace('.gif', '')}.mp4`}>
                <Button className="w-full bg-white border border-border hover:bg-white-hover text-primary">Download MP4/WebM Video</Button>
              </a>
            </div>
          )}
          <Button variant="outline" className="w-full border-border text-primary text-sm mt-2" onClick={() => { setFile(null); setVideoUrl(null) }}>Choose New GIF</Button>
        </div>
      )}
    </div>
  )
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
          <div className="space-y-4">
            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Chart Configuration</h4>
            <div>
              <label className="text-xs text-muted block mb-1">Chart Title</label>
              <input type="text" value={title} onChange={e => setTitle(e.target.value)} className="w-full bg-white border border-border border-border rounded-xl px-3 py-1.5 text-primary text-xs font-semibold" />
            </div>
            <div>
              <label className="text-xs text-muted block mb-1">Chart Labels (comma-separated)</label>
              <input type="text" value={labels} onChange={e => setLabels(e.target.value)} className="w-full bg-white border border-border border-border rounded-xl px-3 py-1.5 text-primary text-xs font-mono" />
            </div>
            <div>
              <label className="text-xs text-muted block mb-1">Values (comma-separated)</label>
              <input type="text" value={values} onChange={e => setValues(e.target.value)} className="w-full bg-white border border-border border-border rounded-xl px-3 py-1.5 text-primary text-xs font-mono" />
            </div>

            <div>
              <label className="text-xs text-muted block mb-1">Type Selector</label>
              <div className="grid grid-cols-3 gap-2">
                <button onClick={() => setChartType('bar')} className={`py-1 rounded text-[10px] font-bold ${chartType === 'bar' ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>Bar</button>
                <button onClick={() => setChartType('line')} className={`py-1 rounded text-[10px] font-bold ${chartType === 'line' ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>Line</button>
                <button onClick={() => setChartType('pie')} className={`py-1 rounded text-[10px] font-bold ${chartType === 'pie' ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>Pie</button>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 space-y-4 bg-surface border border-border p-4 rounded-xl border border-border max-w-[320px] flex flex-col justify-between">
          <div className="space-y-4">
            <h4 className="text-xs font-semibold text-muted uppercase tracking-wider">Icon Config</h4>
            <div>
              <label className="text-xs text-muted block mb-1">Select Icon Glyph</label>
              <select value={selectedIcon} onChange={e => setSelectedIcon(e.target.value)} className="w-full bg-white border border-border border-border rounded-xl px-4 py-2 text-primary text-xs">
                {icons.map(ic => (
            ...
            <div>
              <label className="text-xs text-muted block mb-1">Icon Color</label>
            ...
            <div>
              <label className="text-xs text-muted block mb-1">Backdrop Color</label>
              <input type="color" value={bgColor} onChange={e => setBgColor(e.target.value)} className="w-full h-8 rounded cursor-pointer bg-transparent border-0" />
            </div>

            <div>
              <label className="text-xs text-muted block mb-1">Background Shape</label>
              <div className="grid grid-cols-3 gap-2">
                {['circle', 'square', 'none'].map(shape => (
                  <button key={shape} onClick={() => setBgType(shape as any)} className={`py-1 rounded text-[10px] font-bold uppercase ${bgType === shape ? 'bg-white border border-border text-primary' : 'bg-white border border-border text-muted'}`}>{shape}</button>
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="flex-[2] flex items-center justify-center p-4 bg-white border border-border rounded-2xl border border-border min-h-[350px] bg-[url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAMUlEQVQ4T2NkYGAQYcAP3uCTZvQAw8gAAQMDwzyUog+S1AwybAAx6oZRMwyDQeQAAwMAXgEHB60tE7EAAAAASUVORK5CYII=')]">
          <canvas ref={canvasRef} className="max-w-full max-h-[380px] object-contain rounded-xl shadow-2xl" />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      <div 
        ...
        className="flex flex-col items-center justify-center border-2 border-dashed border-border hover:border-white/30 rounded-2xl p-14 cursor-pointer bg-white/2"
      >
        <FileCode className="w-12 h-12 text-primary mb-4" />
        <p className="text-primary font-medium mb-1">Click to upload PNG to convert to EPS</p>
        <p className="text-muted text-xs">Wraps visual raster image inside PostScript vector format envelope</p>
      </div>
      ...
      {processing && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center">
          ...
          <p className="text-primary font-medium">Encoding PostScript file...</p>
        </div>
      )}
    </div>
  )
...
export function JpgToTiff() {
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      ...
      >
        <ImageIcon className="w-12 h-12 text-primary mb-4" />
        <p className="text-primary font-medium mb-1">Click to upload JPG to convert to TIFF</p>
        <p className="text-muted text-xs">Packs JPG pixels into a standard uncompressed TIFF image container format</p>
      </div>

      {processing && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center">
          <RefreshCw className="w-10 h-10 text-primary animate-spin mb-3" />
          <p className="text-primary font-medium">Encoding TIFF image...</p>
        </div>
      )}
    </div>
  )
...
export function WebpToJpg() {
  ...
  return (
    <div className="flex flex-col gap-6 h-full bg-white border border-border rounded-2xl p-6 ">
      ...
      >
        <ImageIcon className="w-12 h-12 text-primary mb-4" />
        <p className="text-primary font-medium mb-1">Click to upload WebP to convert to JPG</p>
        <p className="text-muted text-xs">Convert static WebP image layouts to standard JPG format client-side</p>
      </div>

      {processing && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex flex-col items-center justify-center">
          <RefreshCw className="w-10 h-10 text-primary animate-spin mb-3" />
          <p className="text-primary font-medium">Converting WebP...</p>
        </div>
      )}
    </div>
  )
