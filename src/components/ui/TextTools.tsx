  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-4 flex-wrap">
        <label className="flex items-center gap-2 cursor-pointer text-[14px] text-[#374151] font-medium select-none">
          <input
            type="checkbox"
        ...
        {duplicatesRemoved > 0 && (
          <span className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#059669] bg-[#ECFDF5] border border-[#A7F3D0] rounded-lg px-3 py-1">
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {changedCount > 0 && (
          <span className="inline-flex items-center text-[13px] font-semibold text-[#D97706] bg-[#FFFBEB] border border-[#FDE68A] rounded-lg px-3 py-1">
      ...
      {(left || right) && (
        <div className="border border-[#E5E7EB] rounded-xl overflow-auto max-h-[320px] bg-white">
          <div className="grid grid-cols-2 divide-x divide-[#E5E7EB] text-xs font-mono">
            <div>
              <div className="sticky top-0 px-3 py-2 bg-[#F9FAFB] border-b border-[#E5E7EB] text-[11px] font-bold text-[#6B7280] uppercase tracking-wider">
                Original
              </div>
              {diff.map((row, i) => (
