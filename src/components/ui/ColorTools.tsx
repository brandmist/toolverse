...
export function HexRgba() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 h-full bg-white border border-[#E5E7EB] rounded-2xl p-6  shadow-lg shadow-sm">
      <div className="flex-1 space-y-6">
        ...
        <div>
           <div className="flex justify-between mb-1">
             <span className="text-sm text-[#111827]">Opacity</span>
             <span className="text-sm text-[#6B7280]">{opacity}%</span>
           </div>
      ...
      <div className="flex-1 right-panel flex items-center justify-center relative rounded-xl border border-[#E5E7EB] min-h-[300px]" style={{
         ...
         <div className="z-10 p-4 bg-[#FAFAFA] border border-[#E5E7EB] backdrop-blur-sm border border-[#E5E7EB] rounded-xl text-center shadow-xl">
            <span className="text-xs text-[#6B7280] block mb-1 font-semibold uppercase">RGBA Output</span>
...
export function ColorShades() {
  ...
  return (
    <div className="flex flex-col h-full gap-6 bg-white border border-[#E5E7EB] rounded-2xl p-6  shadow-lg shadow-sm">
      ...
      <div className="flex-grow min-h-[200px] flex flex-col md:flex-row rounded-xl overflow-hidden shadow-inner border border-[#E5E7EB]">
        {shades.length > 0 ? shades.map((hex, i) => (
          ...
          >
             <span className="text-xs font-mono font-medium opacity-0 group-hover:opacity-100 transition-opacity bg-black/50 text-[#111827] p-1 rounded inline-block text-center mt-auto md:w-full select-all">
               {hex}
             </span>
          </div>
        )) : (
